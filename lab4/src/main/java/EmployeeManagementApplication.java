...
@SpringBootApplication(scanBasePackages = {"service", "config", "model", "exception"})
...
public class EmployeeManagementApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 4. Statystyki dla wybranej firmy
        ...
        System.out.println("Średnia pensja wszystkich pracowników: " 
            + String.format("%.2f", employeeService.averageSalary()) + " zł");
